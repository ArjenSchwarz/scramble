...
5. ~~Explainability disclosure~~ — removed entirely in T-1617 (was tasks-only after phase-4 Decision 10); see `specs/remove-task-why-disclosure/`
...
9. Rules engine: per-item matching / diffing (the explainability exposure this once fed was removed in T-1617)
