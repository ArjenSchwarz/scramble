...
nonisolated enum MidnightAtlas {
    ...
    static let palette = PersonPalette(entries: [
        ...
        PaletteEntry(key: "Yellow", displayName: "Yellow", dark: .hex6(0xFFD60A), light: .hex6(0xC09000)),
        PaletteEntry(key: "Green", displayName: "Green", dark: .hex6(0x30D158), light: .hex6(0x28A745)),
        PaletteEntry(key: "Purple", displayName: "Purple", dark: .hex6(0xBF5AF2), light: .hex6(0x9B40D0)),
        PaletteEntry(key: "Orange", displayName: "Orange", dark: .hex6(0xFF9F0A), light: .hex6(0xE08600)),
...
private extension Color {
    nonisolated static func hex6(_ value: UInt32) -> Color {
