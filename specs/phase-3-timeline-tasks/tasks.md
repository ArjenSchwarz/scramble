...
- [ ] 1. Write failing tests: SchemaV2 migration, dangling assignee, rename local scope <!-- id:je6ekkz -->
...
- [ ] 2. Refactor TripTask into SchemaV1/SchemaV2 namespaces, add migration stage and typealias <!-- id:je6ekl0 -->
...
- [ ] 3. Write failing tests: rules engine respects userDeletedOnThisTrip <!-- id:je6ekl1 -->
...
- [ ] 4. Implement engine carve-out for userDeletedOnThisTrip <!-- id:je6ekl2 -->
...
- [ ] 5. Write PhaseDateMapping tests <!-- id:je6ekl3 -->
...
- [ ] 6. Implement PhaseDateMapping helper <!-- id:je6ekl4 -->
...
- [ ] 7. Write ConditionsFormatter tests <!-- id:je6ekl5 -->
...
- [ ] 8. Implement ConditionsFormatter <!-- id:je6ekl6 -->
...
- [ ] 9. Write task ordering and PhaseCounts tests <!-- id:je6ekl7 -->
...
- [ ] 10. Implement task ordering and PhaseCounts helpers <!-- id:je6ekl8 -->
...
- [ ] 11. Write WhyResolver tests <!-- id:je6ekl9 -->
...
- [ ] 12. Implement WhyResolver <!-- id:je6ekla -->
...
- [ ] 13. Write TripDetailView.autoExpandPhase tests <!-- id:je6eklb -->
...
- [ ] 14. Implement TripDetailView.autoExpandPhase static helper <!-- id:je6eklc -->
...
- [ ] 15. Implement PhaseNode and CompressedSpineDot; delete PhaseNodeMarker <!-- id:je6ekld -->
...
- [ ] 16. Implement WhyDisclosure view <!-- id:je6ekle -->
...
- [ ] 17. Implement TaskRow and TaskListSection <!-- id:je6eklf -->
...
- [ ] 18. Implement PhaseRow <!-- id:je6eklg -->
...
- [ ] 19. Implement AccordionTimeline <!-- id:je6eklh -->
...
- [ ] 20. Implement TaskForm (add + edit modes) <!-- id:je6ekli -->
...
- [ ] 21. Write UI tests: accordion, task interactions, forms, accessibility <!-- id:je6eklj -->
...
- [ ] 22. Wire AccordionTimeline and TaskForm into TripDetailView <!-- id:je6eklk -->
