...
| [Packing Item Sub-items](#packing-item-sub-items) | 2026-06-21 | Planned | Per-trip free-form note plus an appendable sub-item list on packing items, shown inline on the packing sheet and synced across the shared trip. |
