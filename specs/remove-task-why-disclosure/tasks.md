...
- [ ] 1. Task rows render with no WhyDisclosure surface or disclosure-open state <!-- id:605qzb4 -->
...
- [ ] 2. Explainability subsystem is gone from the codebase with no remaining references <!-- id:605qzb5 -->
...
- [ ] 3. Task-disclosure UI tests are removed and the full test suite passes <!-- id:605qzb6 -->
...
- [ ] 4. No stale WhyDisclosure/WhyResolver references remain in code comments or docs <!-- id:605qzb7 -->
