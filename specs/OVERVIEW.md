...
| [Packing Item Categories](#packing-item-categories) | 2026-06-27 | Planned | Optional free-text category on packing items, grouping the Packing Sheet and Master Lists by category with autocomplete suggestions; category re-stamps onto trip items via the rules engine. |
